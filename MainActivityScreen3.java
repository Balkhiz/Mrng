...
public class MainActivityScreen3 extends Activity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView myButton5 =(TextView) findViewById( R.id.signup );
        ...
        mGoogleApiClient = new GoogleApiClient.Builder( MainActivityScreen3.this )
        ...
        FacebookSdk.sdkInitialize(MainActivityScreen3.this.getApplicationContext());
        ...
        LoginManager.getInstance().registerCallback(callbackManager, new FacebookCallback<LoginResult>() {
                        ...
                        new GraphRequest.GraphJSONObjectCallback() {
                            ...
                            public void onCompleted(
                                ...
                                try {
                                    ...
                                    Intent i = new Intent( MainActivityScreen3.this,welcomeActivityScreen4.class );
                                   // saveLoginDetails();
                                    startActivity( i );
                                    finish();
            ...
            public void onCancel() {
                Toast.makeText(MainActivityScreen3.this, "Login Cancel", Toast.LENGTH_LONG).show();
            }
            @Override
            public void onError(FacebookException exception) {
                Toast.makeText(MainActivityScreen3.this, exception.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public void onClick(View view) {
        ...
        Intent i = new Intent( MainActivityScreen3.this, LoginScreen2.class );
        startActivity( i );
    }
